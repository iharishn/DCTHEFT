...
export const CelestialSphere: React.FC<CelestialSphereProps> = ({
    hue = 140.0, // Defaulted to green hue (approx 140-150 for emerald)
    speed = 0.3,
    zoom = 1.5,
    particleSize = 3.0,
    className = "",
    ...
    return <div ref={mountRef} className={className || "w-full h-full"} style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }} />;
};
